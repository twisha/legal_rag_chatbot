...
The judge uses `claude-sonnet-4-6` to score answers generated by `claude-opus-4-8`. Results from the current document corpus:
...
| CFPB | 4–5 | 5 | 4–5 | 4.7 |
| SEC | 5 | 4–5 | 5 | 4.8 |
| **Overall** | **4.9** | **4.3** | **4.9** | **4.7** |

Relevance scores lower when retrieved chunks are truncated and can't fully satisfy the question — the model correctly says so rather than hallucinating.
